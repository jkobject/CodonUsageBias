...
tmp1<-globalPlotOnlyDta(protnamTb[x],c(1:9),c(5:15),0)
...
tmp1<-globalPlotOnlyDta(protnamTab[x],c(1:9),c(5:15),0)
tmp1<-tmp1[which(tmp1[[2]]<  (5)), ]
tmp<-summary(fitMe(tmp1,"V1","V2"))$coef
...
write.table(file="slopes5To15S5P.txt",tmp,sep=",",row.names=F,quote=F)
