...
tmp1<-globalPlotOnlyDta(fnamTb[x],c(1:18),c(5:15),0)
...
tmp1<-globalPlotOnlyDta(fnamTab[x],c(1:9),c(5:10),0)
tmp<-summary(fitMe(tmp1,"V1","V2"))$coef
...
write.table(file="slopes5To10S5.txt",tmp,sep=",",row.names=F,quote=F)
