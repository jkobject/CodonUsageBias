...
histogram(G,'BinWidth',2);

xlim([-170,0]);

xlabel('Gly  ratio of probability');

ylabel('frequency');

title('GlyEqual   Histogram in all mRNAs');


figure 

histogram(GR,'BinWidth',2);

xlim([-170,0]);

xlabel('Gly after replacement  ratio of probability');
