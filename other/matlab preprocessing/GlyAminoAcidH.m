function [NNg,Xg,Y] = GlyAminoAcidH(codonSequence)
...
else NNg=NaN;%% if no subsequece coding for Gly, assign relevant values of such subsequence as '0', which for further convenient operation
    Xg=NaN;
    subsequenceG=NaN;
    Yg=NaN;
    Ygg=NaN;
%     disp('codons coding Gly do not existe');     %% subsequence for Gly ends
end
