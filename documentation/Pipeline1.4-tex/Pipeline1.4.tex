...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}4}]:} \PY{n}{cub} \PY{o}{=} \PY{n}{pyCUB}\PY{o}{.}\PY{n}{PyCUB}\PY{p}{(}\PY{n}{session} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{ensembl2}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        \PY{n}{cub}\PY{o}{.}\PY{n}{load}\PY{p}{(}\PY{n}{session} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{ensembl2}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{n}{filename} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{processed\PYZus{}entropyloc}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\end{Verbatim}
...
unzipping utils/save/ensembl2/processed\_entropyloc.json.gz
loading from processed\_entropyloc
it worked !
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}13}]:} \PY{n}{cub}\PY{o}{.}\PY{n}{compute\PYZus{}averages}\PY{p}{(}\PY{n}{homoset}\PY{o}{=}\PY{n}{cub}\PY{o}{.}\PY{n}{all\PYZus{}homoset}\PY{p}{)}
         \PY{n}{cub}\PY{o}{.}\PY{n}{all\PYZus{}homoset}\PY{o}{.}\PY{n}{compute\PYZus{}ages}\PY{p}{(}\PY{n}{preserved}\PY{o}{=}\PY{n+nb+bp}{True}\PY{p}{,} \PY{n}{minpreserv}\PY{o}{=}\PY{l+m+mf}{0.9}\PY{p}{,} \PY{n}{minsimi}\PY{o}{=}\PY{l+m+mf}{0.85}\PY{p}{)}
         \PY{n}{cub}\PY{o}{.}\PY{n}{import\PYZus{}metadataTobias}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
...
it was already loaded
    ...
    Right of the bat we can see that some amino acids are very litlle pushed
to an unusual entorpy value. This could be explained by some reasons
regarding the general role of this amino acid. But it relatively vary
between species. So there is some other factors

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}14}]:} \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{,}\PY{l+m+mi}{3}\PY{p}{,}\PY{l+m+mi}{514}\PY{p}{,}\PY{l+m+mi}{516}\PY{p}{,}\PY{l+m+mi}{518}\PY{p}{,}\PY{l+m+mi}{519}\PY{p}{,}\PY{l+m+mi}{31}\PY{p}{]}\PY{p}{:}
             \PY{k}{print} \PY{n}{cub}\PY{o}{.}\PY{n}{species}\PY{p}{[}\PY{n}{cub}\PY{o}{.}\PY{n}{all\PYZus{}homoset}\PY{o}{.}\PY{n}{species\PYZus{}namelist}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{]}\PY{o}{.}\PY{n}{name}
             \PY{k}{print} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}}\PY{l+s+s2}{\PYZdq{}}
             \PY{k}{print} \PY{n}{cub}\PY{o}{.}\PY{n}{species}\PY{p}{[}\PY{n}{cub}\PY{o}{.}\PY{n}{all\PYZus{}homoset}\PY{o}{.}\PY{n}{species\PYZus{}namelist}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{]}\PY{o}{.}\PY{n}{genome\PYZus{}size}
             \PY{k}{print} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}}\PY{l+s+s2}{\PYZdq{}}
             \PY{k}{print} \PY{n}{cub}\PY{o}{.}\PY{n}{species}\PY{p}{[}\PY{n}{cub}\PY{o}{.}\PY{n}{all\PYZus{}homoset}\PY{o}{.}\PY{n}{species\PYZus{}namelist}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{]}\PY{o}{.}\PY{n}{metadata}\PY{o}{.}\PY{n}{values}\PY{p}{(}\PY{p}{)}
             \PY{k}{print} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}}\PY{l+s+s2}{\PYZdq{}}
             \PY{k}{print} \PY{n}{cub}\PY{o}{.}\PY{n}{species}\PY{p}{[}\PY{n}{cub}\PY{o}{.}\PY{n}{all\PYZus{}homoset}\PY{o}{.}\PY{n}{species\PYZus{}namelist}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{]}\PY{o}{.}\PY{n}{average\PYZus{}entropy}
             \PY{k}{print} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}}\PY{l+s+s2}{\PYZdq{}}
             \PY{k}{print} \PY{n}{cub}\PY{o}{.}\PY{n}{species}\PY{p}{[}\PY{n}{cub}\PY{o}{.}\PY{n}{all\PYZus{}homoset}\PY{o}{.}\PY{n}{species\PYZus{}namelist}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{]}\PY{o}{.}\PY{n}{average\PYZus{}size}
             \PY{k}{print} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}}\PY{l+s+s2}{\PYZdq{}}
             \PY{k}{print} \PY{n}{cub}\PY{o}{.}\PY{n}{species}\PY{p}{[}\PY{n}{cub}\PY{o}{.}\PY{n}{all\PYZus{}homoset}\PY{o}{.}\PY{n}{species\PYZus{}namelist}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{]}\PY{o}{.}\PY{n}{meanGChomo}
             \PY{k}{print} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}}\PY{l+s+s2}{\PYZdq{}}
             \PY{k}{print} \PY{n}{cub}\PY{o}{.}\PY{n}{species}\PY{p}{[}\PY{n}{cub}\PY{o}{.}\PY{n}{all\PYZus{}homoset}\PY{o}{.}\PY{n}{species\PYZus{}namelist}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{]}\PY{o}{.}\PY{n}{tot\PYZus{}homologies}
             \PY{k}{print} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}}\PY{l+s+s2}{\PYZdq{}}
             \PY{k}{print} \PY{n}{cub}\PY{o}{.}\PY{n}{species}\PY{p}{[}\PY{n}{cub}\PY{o}{.}\PY{n}{all\PYZus{}homoset}\PY{o}{.}\PY{n}{species\PYZus{}namelist}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{]}\PY{o}{.}\PY{n}{meanecai}
             \PY{k}{print} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}}\PY{l+s+s2}{\PYZdq{}}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
zygosaccharomyces\_parabailii
----
0
----
...
None
----
zygosaccharomyces\_bailii\_isa1307
----
21141148
----
[False, False, False, False, False]
...
None
----
stereum\_hirsutum\_fp\_91666\_ss1
----
46511623
----
[False, False, False, False, False]
...
None
----
fomitiporia\_mediterranea\_mf3\_22
----
63354419
----
...
None
----
colletotrichum\_nymphaeae\_sa\_01
----
49956273
----
[False, True, False, False, False]
...
----
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}6}]:} \PY{n}{secondaryhomo} \PY{o}{=} \PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{10}\PY{p}{,}\PY{l+m+mi}{23}\PY{p}{,}\PY{l+m+mi}{26}\PY{p}{,}\PY{l+m+mi}{34}\PY{p}{,}\PY{l+m+mi}{36}\PY{p}{,}\PY{l+m+mi}{176}\PY{p}{,}\PY{l+m+mi}{140}\PY{p}{,}\PY{l+m+mi}{133}\PY{p}{]}
        \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n}{secondaryhomo}\PY{p}{:}
            \PY{k}{print} \PY{n}{cub}\PY{o}{.}\PY{n}{working\PYZus{}homoset}\PY{p}{[}\PY{n}{i}\PY{p}{]}
\end{Verbatim}
...
metrics: \{u'silhouette': 0.019158784567542567, u'cal\_hara': 9.23972136790517, u'cluster\_phylodistance': [1.0043587230156612, 0.7776937334750729, 1.0070891024138091, 1.1877504293073842]\}
...
decay\_rate: 0.0007
tot\_volume: 95785.0
mean\_hydrophobicity: -0.6
glucose\_cost: 673.77
synthesis\_steps: 3483
...
metrics: \{u'silhouette': 0.07960581175743578, u'cal\_hara': 32.09784054797007, u'cluster\_phylodistance': [1.0026123455461668, 1.028626831370296, 0.8962667611572063, 0.9259002099834477, 0.7578271750636014, 0.951378176049997]\}
...
decay\_rate: nan
tot\_volume: 13328.9
mean\_hydrophobicity: -0.382291666667
glucose\_cost: 92.07
synthesis\_steps: 497
...
metrics: \{u'silhouette': 0.09203153617530613, u'cal\_hara': 28.38199866715687, u'cluster\_phylodistance': [1.0064131983336058, 1.1363601011083024, 1.003642183120282, 0.9544638941877908, 1.0158370600816644]\}
...
decay\_rate: 0.0016
tot\_volume: 23902.8
mean\_hydrophobicity: 0.0116279069767
glucose\_cost: 165.66
synthesis\_steps: 885
isoelectricpoint: 6.085
...
metrics: \{u'silhouette': 0.1119298553309341, u'cal\_hara': 23.041643284721186, u'cluster\_phylodistance': [1.0130432665451445, 0.9708495866325105, 1.010328479756667, 0.7532398788124209, 1.0277136338495574]\}
...
protein\_abundance: 64233
weight: 22249
conservation: 5.14564102564
mRNA\_abundance: 34.5
cys\_elements: 0
is\_secreted: True
decay\_rate: 0.0012
tot\_volume: 27214.8
mean\_hydrophobicity: -0.391282051282
glucose\_cost: 195.9
synthesis\_steps: 1084
isoelectricpoint: 6.97
...
metrics: \{u'silhouette': 0.318377314939839, u'cal\_hara': 49.21907634300182, u'cluster\_phylodistance': [1.0124431935897884, 1.0036369714073807, 0.9945149305527152, 1.0202334794870385, 1.071090817608709]\}
...
protein\_abundance: 118213
weight: 17029
conservation: 5.25479452055
mRNA\_abundance: 18.6
cys\_elements: 0
is\_secreted: True
decay\_rate: 0.0011
tot\_volume: 20505.2
mean\_hydrophobicity: -0.331506849315
glucose\_cost: 143.85
synthesis\_steps: 806
isoelectricpoint: 6.97
othercods: 4.34155597723

    \end{Verbatim}

    THis is interesting that this homology has little to do with anything
and it should not be a secondary cluster However, we can see that tSNE
shows a non linear secondary cluster. For the seconda one however, there
is this notion of clusters that is even more present. Clusters show much
more using \[ A_{value}\] For most of them, there seems to be an equal
correlation of the value to nans, cai length and GC whether it is high
or low, which also hints on the idea that it is not correlation to the
measure in itself.

mRNA abundance seems also to be linked with the secondary cluster
presence/outlier cluster presence

Looking at the plot of many homologies, we kinda see different small
groups and bigger groups within them. It resembles a lot a small world
graph\ldots{} If one would overlay previous knowledge about the CUB it
seems that different values cluster show the different drivers of the
CUB, it can be about the general protein function (with a cluster of one
homology). It can be related to the species environment with small
clusters and or usage of the protein.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}15}]:} \PY{n}{cub}\PY{o}{.}\PY{n}{working\PYZus{}homoset}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{tsne}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{D}\PY{o}{=}\PY{l+m+mi}{2}\PY{p}{,}\PY{n}{interactive}\PY{o}{=}\PY{n+nb+bp}{True}\PY{p}{,}\PY{n}{correlation}\PY{o}{=}\PY{n+nb+bp}{True}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
 if you are on a notebook you should write 'from bokeh.io import output\_notebook'
similarity\_scores: SpearmanrResult(correlation=-0.15984702808231441, pvalue=0.00016691732866527833)
...
cal\_hara: 9.23972136791
cluster\_phylodistance: [1.0043587230156612, 0.7776937334750729, 1.0070891024138091, 1.1877504293073842]
------------------------------------
...
the isoelectricpoint(Pi) is : 6.085
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}16}]:} \PY{n}{cub}\PY{o}{.}\PY{n}{working\PYZus{}homoset}\PY{p}{[}\PY{l+m+mi}{10}\PY{p}{]}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{tsne}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{D}\PY{o}{=}\PY{l+m+mi}{2}\PY{p}{,}\PY{n}{interactive}\PY{o}{=}\PY{n+nb+bp}{True}\PY{p}{,}\PY{n}{correlation}\PY{o}{=}\PY{n+nb+bp}{True}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
 if you are on a notebook you should write 'from bokeh.io import output\_notebook'
similarity\_scores: SpearmanrResult(correlation=0.076068123058873977, pvalue=0.10513054355778929)
...
cal\_hara: 32.097840548
cluster\_phylodistance: [1.0026123455461668, 1.028626831370296, 0.8962667611572063, 0.9259002099834477, 0.7578271750636014, 0.951378176049997]
------------------------------------
Amino, CUB value mean, variance
ALA: 0.84, 0.119
ARG: 0.91, 0.085
...
the isoelectricpoint(Pi) is : 6.97
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}17}]:} \PY{n}{cub}\PY{o}{.}\PY{n}{working\PYZus{}homoset}\PY{p}{[}\PY{l+m+mi}{23}\PY{p}{]}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{tsne}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{D}\PY{o}{=}\PY{l+m+mi}{2}\PY{p}{,}\PY{n}{interactive}\PY{o}{=}\PY{n+nb+bp}{True}\PY{p}{,}\PY{n}{correlation}\PY{o}{=}\PY{n+nb+bp}{True}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
 if you are on a notebook you should write 'from bokeh.io import output\_notebook'
similarity\_scores: SpearmanrResult(correlation=0.083325425568418557, pvalue=0.055688760565223074)
...
cal\_hara: 28.3819986672
cluster\_phylodistance: [1.0064131983336058, 1.1363601011083024, 1.003642183120282, 0.9544638941877908, 1.0158370600816644]
------------------------------------
Amino, CUB value mean, variance
ALA: 0.96, 0.032
ARG: 0.26, 0.189
...
the isoelectricpoint(Pi) is : 6.085
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}21}]:} \PY{n}{cub}\PY{o}{.}\PY{n}{working\PYZus{}homoset}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{YDR064W}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{tsne}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{D}\PY{o}{=}\PY{l+m+mi}{2}\PY{p}{,}\PY{n}{interactive}\PY{o}{=}\PY{n+nb+bp}{True}\PY{p}{,}\PY{n}{correlation}\PY{o}{=}\PY{n+nb+bp}{True}\PY{p}{)}
\end{Verbatim}
...
the isoelectricpoint(Pi) is : 6.97
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}19}]:} \PY{n}{cub}\PY{o}{.}\PY{n}{get\PYZus{}subset}\PY{p}{(}\PY{n}{homoset} \PY{o}{=} \PY{n}{cub}\PY{o}{.}\PY{n}{working\PYZus{}homoset}\PY{p}{,} \PY{n}{withcopy}\PY{o}{=}\PY{n+nb+bp}{True}\PY{p}{,} \PY{n}{clusternb}\PY{o}{=}\PY{n+nb+bp}{None}\PY{p}{,} \PY{n}{species}\PY{o}{=}\PY{n+nb+bp}{None}\PY{p}{,}
                        \PY{n}{homologies}\PY{o}{=}\PY{p}{[}\PY{n}{cub}\PY{o}{.}\PY{n}{working\PYZus{}homoset}\PY{o}{.}\PY{n}{homo\PYZus{}namelist}\PY{p}{[}\PY{n}{i}\PY{p}{]} \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n}{secondaryhomo}\PY{p}{]}
                       \PY{p}{)}\PY{o}{.}\PY{n}{compare\PYZus{}clusters}\PY{p}{(}\PY{n}{cubdistance\PYZus{}matrix}\PY{o}{=}\PY{n+nb+bp}{True}\PY{p}{,} \PY{n}{plot}\PY{o}{=}\PY{n+nb+bp}{True}\PY{p}{,} \PY{n}{size}\PY{o}{=}\PY{l+m+mi}{40}\PY{p}{)}
\end{Verbatim}
...
loaded
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}33}]:} \PY{n}{cub}\PY{o}{.}\PY{n}{loadspeciestable}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
...
it worked !
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}23}]:} \PY{n}{cub}\PY{o}{.}\PY{n}{get\PYZus{}subset}\PY{p}{(}\PY{n}{homoset} \PY{o}{=} \PY{n}{cub}\PY{o}{.}\PY{n}{working\PYZus{}homoset}\PY{p}{,} \PY{n}{withcopy}\PY{o}{=}\PY{n+nb+bp}{True}\PY{p}{,} \PY{n}{clusternb}\PY{o}{=}\PY{n+nb+bp}{None}\PY{p}{,} \PY{n}{species}\PY{o}{=}\PY{n+nb+bp}{None}\PY{p}{,}
                        \PY{n}{homologies}\PY{o}{=}\PY{p}{[}\PY{n}{cub}\PY{o}{.}\PY{n}{working\PYZus{}homoset}\PY{o}{.}\PY{n}{homo\PYZus{}namelist}\PY{p}{[}\PY{n}{i}\PY{p}{]} \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n}{secondaryhomo}\PY{p}{[}\PY{p}{:}\PY{l+m+mi}{6}\PY{p}{]}\PY{p}{]}\PY{p}{)}\PY{o}{.}\PY{n}{plot\PYZus{}all}\PY{p}{(}\PY{n}{With}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{tsne}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{perplexity}\PY{o}{=}\PY{l+m+mi}{60}\PY{p}{,}
                                                  \PY{n}{interactive}\PY{o}{=}\PY{n+nb+bp}{True}\PY{p}{,} \PY{n}{iteration}\PY{o}{=}\PY{l+m+mi}{300}\PY{p}{)}
\end{Verbatim}
...
loaded
    ...
    Here it tends to be mostly the lengths and number of NaN values that
seem to be corelated with the entropy values. If they are correlated to
the first cluster, they don't explain all the other ones.

Compared to other metrics, it seems to be for now the best one for
clustering and finding clusters etc..

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}7}]:} \PY{n}{outlierhomo} \PY{o}{=} \PY{p}{[}\PY{l+m+mi}{5}\PY{p}{,}\PY{l+m+mi}{14}\PY{p}{,}\PY{l+m+mi}{39}\PY{p}{,}\PY{l+m+mi}{41}\PY{p}{,}\PY{l+m+mi}{25}\PY{p}{,}\PY{l+m+mi}{58}\PY{p}{,}\PY{l+m+mi}{64}\PY{p}{,}\PY{l+m+mi}{74}\PY{p}{,}\PY{l+m+mi}{80}\PY{p}{,}\PY{l+m+mi}{97}\PY{p}{,}\PY{l+m+mi}{98}\PY{p}{,}\PY{l+m+mi}{101}\PY{p}{,}\PY{l+m+mi}{103}\PY{p}{,}\PY{l+m+mi}{104}\PY{p}{]}
        \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n}{outlierhomo}\PY{p}{:}
            \PY{k}{print} \PY{n}{cub}\PY{o}{.}\PY{n}{working\PYZus{}homoset}\PY{p}{[}\PY{n}{i}\PY{p}{]}
\end{Verbatim}
...
metrics: \{u'silhouette': -0.006127996130373387, u'cal\_hara': 15.464467804328489, u'cluster\_phylodistance': [1.0033101331757437, 1.1036555780798245, 1.0606560101026885, 1.0150504077026956, 0.9495231199368648, 0.8414425262976813, 1.0367673612265018, 0.7338592934764547, 0.9173241168455684, 0.6142795425305145, 0.9746568741484164]\}
...
tot\_volume: 12690.8
mean\_hydrophobicity: -1.38
glucose\_cost: 89.55
synthesis\_steps: 472
isoelectricpoint: 6.97
...
metrics: \{u'silhouette': 0.11192530707980843, u'cal\_hara': 23.20675463500841, u'cluster\_phylodistance': [0.9958278842645163, 0.7605439170470437, 0.9674431713243354, 0.9398491496015309, 0.9538014622511075, 0.9987520118202686, 1.0050137799194552, 0.8616170216915235, 0.9614423102292815, 0.8495132054563205, 1.0504115986385583]\}
...
decay\_rate: 0.00673
tot\_volume: 13318.0
mean\_hydrophobicity: -1.46458333333
glucose\_cost: 93.79
synthesis\_steps: 493
isoelectricpoint: 6.97
...
metrics: \{u'silhouette': -0.03787710680069241, u'cal\_hara': 12.339061017040038, u'cluster\_phylodistance': [0.9939829138729716, 0.9731059060592688, 0.754014810250603, 0.9466937383827301, 0.8681073213096102, 0.7966948938496938, 0.6518412767861131, 0.7966948938496938, 1.3657626751709036]\}
...
decay\_rate: nan
tot\_volume: 11522.2
mean\_hydrophobicity: -1.10487804878
glucose\_cost: 81.34
synthesis\_steps: 444
isoelectricpoint: 6.97
...
metrics: \{u'silhouette': -0.08738000454952546, u'cal\_hara': 9.911451643608068, u'cluster\_phylodistance': [0.9952986789003964, 0.8381512965059732, 0.8710199748003252, 0.8915628987342952, 0.6557301319723202, 0.4716655335239497, 0.920322992241853, 1.222303974071211, 0.9490830857494109, 0.8052826182116215, 0.3451211220906949]\}
...
decay\_rate: 0.000891
tot\_volume: 7877.9
mean\_hydrophobicity: -0.891071428571
glucose\_cost: 56.69
synthesis\_steps: 325
isoelectricpoint: 6.97
...
metrics: \{u'silhouette': 0.026148471781849213, u'cal\_hara': 8.991201086603738, u'cluster\_phylodistance': [1.0107885950800126, 0.9459057256594368, 0.9939478028778306, 1.2898714440810501, 1.1178885848702436, 1.135086870791324, 1.0318971552648402]\}
...
is\_secreted: True
decay\_rate: 0.0009
tot\_volume: 116346.8
mean\_hydrophobicity: -0.30119474313
glucose\_cost: 824.52
synthesis\_steps: 4246
isoelectricpoint: 6.97
...
decay\_rate: 0.000891
tot\_volume: 11501.7
mean\_hydrophobicity: -0.278571428571
glucose\_cost: 82.09
synthesis\_steps: 412
isoelectricpoint: 6.97
...
decay\_rate: 0.000891
tot\_volume: 13106.5
mean\_hydrophobicity: -0.421276595745
glucose\_cost: 93.1
synthesis\_steps: 460
isoelectricpoint: 6.97
...
metrics: \{u'silhouette': -0.05037203056197734, u'cal\_hara': 7.450955836952141, u'cluster\_phylodistance': [0.999576828141557, 0.8940280845574029]\}
...
protein\_abundance: 4579.0
weight: 11105
conservation: 5.0
mRNA\_abundance: nan
cys\_elements: 0
is\_secreted: False
decay\_rate: 0.138629
tot\_volume: 12279.3
mean\_hydrophobicity: -1.10989010989
glucose\_cost: 83.75
synthesis\_steps: 419
isoelectricpoint: 6.97
...
metrics: \{u'silhouette': -0.0702036230377039, u'cal\_hara': 11.52357432681939, u'cluster\_phylodistance': [0.9926700207213701, 1.0019960564849055, 0.8359305056337951, 1.0041731255918798, 0.7572118487694867, 0.786738348532825, 0.48984054906920965, 0.22859225623229784]\}
...
decay\_rate: 0.000891
tot\_volume: 11732.0
mean\_hydrophobicity: -0.22183908046
glucose\_cost: 81.11
synthesis\_steps: 427
isoelectricpoint: 5.965
othercods: 3.0
...
metrics: \{u'silhouette': -0.06632140963739717, u'cal\_hara': 15.366267885428824, u'cluster\_phylodistance': [1.0026547220398945, 0.951289635081507, 0.845974448620578, 0.43054056760154413, 1.0156341594703093, 0.7032162604158554, 0.87830275790715, 0.9146595169490582]\}
...
protein\_abundance: 3687.0
weight: 10975
conservation: 5.0
mRNA\_abundance: 4.3
cys\_elements: 0
is\_secreted: False
decay\_rate: 0.099021
tot\_volume: 11956.2
mean\_hydrophobicity: -0.593023255814
glucose\_cost: 87.43
synthesis\_steps: 459
isoelectricpoint: 6.97
...
metrics: \{u'silhouette': -0.09274387234855563, u'cal\_hara': 10.975260696400671, u'cluster\_phylodistance': [0.9890750632958076, 1.011151080096839, 0.7420544216839705, 0.9898383282252964, 1.061708634101681, 0.562656649408725, 0.1712433280809163]\}
...
decay\_rate: 0.099021
tot\_volume: 13421.6
mean\_hydrophobicity: -0.961855670103
glucose\_cost: 93.4
synthesis\_steps: 480
isoelectricpoint: 6.205
...
metrics: \{u'silhouette': -0.08513716814753813, u'cal\_hara': 8.95297206273916, u'cluster\_phylodistance': [0.9852693665475121, 0.7606626896472747, 0.9773268573951666, 0.9144578782644832, 0.3000564913055336, 0.3943599600015584, 0.9201732400036362]\}
...
decay\_rate: nan
tot\_volume: 8931.1
mean\_hydrophobicity: 0.825
glucose\_cost: 64.27
synthesis\_steps: 337
isoelectricpoint: 6.97
...
metrics: \{u'silhouette': -0.10856905785111244, u'cal\_hara': 9.585301109211395, u'cluster\_phylodistance': [0.9997583023366902, 0.8919863180627037, 0.6254224729292545, 0.9520211228828729, 0.666962496915067, 0.9706432933827785, 0.8798228682709396, 1.2203994624403356, 0.17028829708469798, 0.9649670168132886, 1.021729782508188]\}
...
decay\_rate: 0.000891
tot\_volume: 10626.8
mean\_hydrophobicity: -0.358441558442
glucose\_cost: 73.98
synthesis\_steps: 359
...
metrics: \{u'silhouette': -0.12185911306834026, u'cal\_hara': 6.935561620096108, u'cluster\_phylodistance': [0.9991507010058395, 0.8916375547657582, 0.585039378039287, 0.9463872291811996, 0.7599776234333876, 0.8603520265283633, 1.0897792336025933, 1.1528717155480068]\}
...
protein\_abundance: 1579.0
weight: 17318
conservation: 4.55547945205
mRNA\_abundance: 0.3
cys\_elements: 0
is\_secreted: False
decay\_rate: 0.231049
tot\_volume: 19820.4
mean\_hydrophobicity: -1.49794520548
glucose\_cost: 133.71
synthesis\_steps: 688
isoelectricpoint: 6.97
othercods: 4.95161290323
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}34}]:} \PY{n}{cub}\PY{o}{.}\PY{n}{working\PYZus{}homoset}\PY{p}{[}\PY{l+m+mi}{5}\PY{p}{]}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{tsne}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{D}\PY{o}{=}\PY{l+m+mi}{2}\PY{p}{,}\PY{n}{interactive}\PY{o}{=}\PY{n+nb+bp}{True}\PY{p}{,}\PY{n}{correlation}\PY{o}{=}\PY{n+nb+bp}{True}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
 if you are on a notebook you should write 'from bokeh.io import output\_notebook'
similarity\_scores: SpearmanrResult(correlation=-0.070792112705935481, pvalue=0.11986243176343638)
...
cal\_hara: 15.4644678043
cluster\_phylodistance: [1.0033101331757437, 1.1036555780798245, 1.0606560101026885, 1.0150504077026956, 0.9495231199368648, 0.8414425262976813, 1.0367673612265018, 0.7338592934764547, 0.9173241168455684, 0.6142795425305145, 0.9746568741484164]
------------------------------------
Amino, CUB value mean, variance
ALA: 0.98, 0.016
ARG: 0.83, 0.141
...
the isoelectricpoint(Pi) is : 6.97
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}36}]:} \PY{n}{cub}\PY{o}{.}\PY{n}{working\PYZus{}homoset}\PY{p}{[}\PY{l+m+mi}{14}\PY{p}{]}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{tsne}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{D}\PY{o}{=}\PY{l+m+mi}{2}\PY{p}{,}\PY{n}{interactive}\PY{o}{=}\PY{n+nb+bp}{True}\PY{p}{,}\PY{n}{correlation}\PY{o}{=}\PY{n+nb+bp}{True}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
 if you are on a notebook you should write 'from bokeh.io import output\_notebook'
similarity\_scores: SpearmanrResult(correlation=-0.056817674870850376, pvalue=0.20836000240005659)
...
cal\_hara: 23.206754635
cluster\_phylodistance: [0.9958278842645163, 0.7605439170470437, 0.9674431713243354, 0.9398491496015309, 0.9538014622511075, 0.9987520118202686, 1.0050137799194552, 0.8616170216915235, 0.9614423102292815, 0.8495132054563205, 1.0504115986385583]
------------------------------------
Amino, CUB value mean, variance
ALA: 0.98, 0.022
ARG: 0.84, 0.131
...
the isoelectricpoint(Pi) is : 6.97
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}40}]:} \PY{n}{cub}\PY{o}{.}\PY{n}{working\PYZus{}homoset}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{YBR089C\PYZhy{}A}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{tsne}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{D}\PY{o}{=}\PY{l+m+mi}{2}\PY{p}{,}\PY{n}{interactive}\PY{o}{=}\PY{n+nb+bp}{True}\PY{p}{,}\PY{n}{correlation}\PY{o}{=}\PY{n+nb+bp}{True}\PY{p}{)}
\end{Verbatim}
...
the isoelectricpoint(Pi) is : 6.97
    ...
    We can really see that there is differences amongst homologies with a
lot of secondary clusters and others here. Moreover we can see in the
full plot of mulitple homologies that most principal clusters are in
their own region, as if principaly influenced by factors related to the
underlying protein, then there is small clusters that are shared by all
homology groups and that contain either similar species, either similar

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}38}]:} \PY{n}{cub}\PY{o}{.}\PY{n}{get\PYZus{}subset}\PY{p}{(}\PY{n}{homoset} \PY{o}{=} \PY{n}{cub}\PY{o}{.}\PY{n}{working\PYZus{}homoset}\PY{p}{,} \PY{n}{withcopy}\PY{o}{=}\PY{n+nb+bp}{True}\PY{p}{,} \PY{n}{clusternb}\PY{o}{=}\PY{n+nb+bp}{None}\PY{p}{,} \PY{n}{species}\PY{o}{=}\PY{n+nb+bp}{None}\PY{p}{,}
                        \PY{n}{homologies}\PY{o}{=}\PY{n}{cub}\PY{o}{.}\PY{n}{working\PYZus{}homoset}\PY{o}{.}\PY{n}{homo\PYZus{}namelist}\PY{p}{[}\PY{p}{:}\PY{l+m+mi}{40}\PY{p}{]}
                       \PY{p}{)}\PY{o}{.}\PY{n}{compare\PYZus{}clusters}\PY{p}{(}\PY{n}{cubdistance\PYZus{}matrix}\PY{o}{=}\PY{n+nb+bp}{True}\PY{p}{,} \PY{n}{plot}\PY{o}{=}\PY{n+nb+bp}{True}\PY{p}{,} \PY{n}{size}\PY{o}{=}\PY{l+m+mi}{40}\PY{p}{)}
\end{Verbatim}
...
loaded
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}41}]:} \PY{n}{cub}\PY{o}{.}\PY{n}{get\PYZus{}subset}\PY{p}{(}\PY{n}{homoset} \PY{o}{=} \PY{n}{cub}\PY{o}{.}\PY{n}{working\PYZus{}homoset}\PY{p}{,} \PY{n}{withcopy}\PY{o}{=}\PY{n+nb+bp}{True}\PY{p}{,} \PY{n}{clusternb}\PY{o}{=}\PY{n+nb+bp}{None}\PY{p}{,} \PY{n}{species}\PY{o}{=}\PY{n+nb+bp}{None}\PY{p}{,}
                        \PY{n}{homologies}\PY{o}{=}\PY{p}{[}\PY{n}{cub}\PY{o}{.}\PY{n}{working\PYZus{}homoset}\PY{o}{.}\PY{n}{homo\PYZus{}namelist}\PY{p}{[}\PY{n}{i}\PY{p}{]} \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n}{outlierhomo}\PY{p}{[}\PY{p}{:}\PY{l+m+mi}{6}\PY{p}{]}\PY{p}{]}\PY{p}{)}\PY{o}{.}\PY{n}{plot\PYZus{}all}\PY{p}{(}\PY{n}{With}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{tsne}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{perplexity}\PY{o}{=}\PY{l+m+mi}{60}\PY{p}{,}
                                                  \PY{n}{interactive}\PY{o}{=}\PY{n+nb+bp}{True}\PY{p}{,} \PY{n}{iteration}\PY{o}{=}\PY{l+m+mi}{300}\PY{p}{)}
\end{Verbatim}
...
loaded
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}8}]:} \PY{n}{primaryhomo} \PY{o}{=} \PY{p}{[}\PY{l+m+mi}{3110}\PY{p}{,}\PY{l+m+mi}{3120}\PY{p}{,}\PY{l+m+mi}{3130}\PY{p}{,}\PY{l+m+mi}{3140}\PY{p}{,}\PY{l+m+mi}{3150}\PY{p}{,}\PY{l+m+mi}{3160}\PY{p}{,}\PY{l+m+mi}{3161}\PY{p}{,}\PY{l+m+mi}{3164}\PY{p}{,}\PY{l+m+mi}{3167}\PY{p}{,}\PY{l+m+mi}{3170}\PY{p}{,}\PY{l+m+mi}{3171}\PY{p}{]}
        \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n}{primaryhomo}\PY{p}{:}
            \PY{k}{print} \PY{n}{cub}\PY{o}{.}\PY{n}{working\PYZus{}homoset}\PY{p}{[}\PY{n}{i}\PY{p}{]}
\end{Verbatim}
...
metrics: \{u'silhouette': 0.11350662099142274, u'cal\_hara': 16.503305936881024, u'cluster\_phylodistance': [1.0231283001715883, 1.0009355908897792, 0.933388446510322, 1.0040996924580736, 0.933388446510322]\}
...
protein\_abundance: 286966
weight: 35847
conservation: 5.20342679128
mRNA\_abundance: 30.7
cys\_elements: 2
is\_secreted: True
decay\_rate: 0.0001
tot\_volume: 41918.5
mean\_hydrophobicity: -0.135514018692
glucose\_cost: 292.02
synthesis\_steps: 1551
isoelectricpoint: 6.205
...
metrics: \{u'silhouette': 0.097626572981556, u'cal\_hara': 19.227735984474226, u'cluster\_phylodistance': [0.9744808755076986, 1.003551769094611, 0.9728708890807559]\}
...
decay\_rate: 0.000891
tot\_volume: 64688.9
mean\_hydrophobicity: -0.223010752688
glucose\_cost: 454.59
synthesis\_steps: 2469
isoelectricpoint: 6.97
...
metrics: \{u'silhouette': 0.22330149163740665, u'cal\_hara': 13.24005012815794, u'cluster\_phylodistance': [1.0158336221861963, 0.9871599055156934]\}
...
decay\_rate: 0.0
tot\_volume: 28132.4
mean\_hydrophobicity: -1.21212121212
glucose\_cost: 206.37
synthesis\_steps: 1143
isoelectricpoint: 6.97
othercods: 6.8099009901
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}42}]:} \PY{n}{cub}\PY{o}{.}\PY{n}{working\PYZus{}homoset}\PY{p}{[}\PY{l+m+mi}{3120}\PY{p}{]}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{tsne}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{D}\PY{o}{=}\PY{l+m+mi}{2}\PY{p}{,}\PY{n}{interactive}\PY{o}{=}\PY{n+nb+bp}{True}\PY{p}{,}\PY{n}{correlation}\PY{o}{=}\PY{n+nb+bp}{True}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
 if you are on a notebook you should write 'from bokeh.io import output\_notebook'
similarity\_scores: SpearmanrResult(correlation=0.0371730540226008, pvalue=0.28592102682190379)
...
cal\_hara: 19.2277359845
cluster\_phylodistance: [0.9744808755076986, 1.003551769094611, 0.9728708890807559]
------------------------------------
Amino, CUB value mean, variance
ALA: 0.95, 0.040
ARG: 0.95, 0.036
...
the isoelectricpoint(Pi) is : 6.97
    ...
    For homology \{YBL003C,YDR225W\} there seems to be 2-3 very distinct
clusters, they have not been catched by the clustering but by tSNE.
Something that might explain this

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}51}]:} \PY{n}{cub}\PY{o}{.}\PY{n}{working\PYZus{}homoset}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{YBL003C}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{tsne}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{D}\PY{o}{=}\PY{l+m+mi}{2}\PY{p}{,}\PY{n}{interactive}\PY{o}{=}\PY{n+nb+bp}{True}\PY{p}{,}\PY{n}{correlation}\PY{o}{=}\PY{n+nb+bp}{True}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
 if you are on a notebook you should write 'from bokeh.io import output\_notebook'
similarity\_scores: SpearmanrResult(correlation=0.37483760198015076, pvalue=7.7121359818286199e-25)
...
cal\_hara: 22.7741112286
cluster\_phylodistance: [0.9489608495206535, 1.0031437995176056, 0.7330247926503913, 0.8074726231539466, 1.0136358460868693, 0.5936737252975826]
------------------------------------
Amino, CUB value mean, variance
ALA: 0.97, 0.028
ARG: 0.99, 0.007
...
the isoelectricpoint(Pi) is : 6.97
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}54}]:} \PY{n}{cub}\PY{o}{.}\PY{n}{working\PYZus{}homoset}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{YMR121C}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{tsne}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{D}\PY{o}{=}\PY{l+m+mi}{2}\PY{p}{,}\PY{n}{interactive}\PY{o}{=}\PY{n+nb+bp}{True}\PY{p}{,}\PY{n}{correlation}\PY{o}{=}\PY{n+nb+bp}{True}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
 if you are on a notebook you should write 'from bokeh.io import output\_notebook'
similarity\_scores: SpearmanrResult(correlation=0.045255382799603602, pvalue=0.31011147342294748)
...
cal\_hara: 13.2400501282
cluster\_phylodistance: [1.0158336221861963, 0.9871599055156934]
------------------------------------
Amino, CUB value mean, variance
ALA: 0.99, 0.012
ARG: 0.98, 0.017
...
the isoelectricpoint(Pi) is : 6.97
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}56}]:} \PY{n}{cub}\PY{o}{.}\PY{n}{get\PYZus{}subset}\PY{p}{(}\PY{n}{homoset} \PY{o}{=} \PY{n}{cub}\PY{o}{.}\PY{n}{working\PYZus{}homoset}\PY{p}{,} \PY{n}{withcopy}\PY{o}{=}\PY{n+nb+bp}{True}\PY{p}{,} \PY{n}{clusternb}\PY{o}{=}\PY{n+nb+bp}{None}\PY{p}{,} \PY{n}{species}\PY{o}{=}\PY{n+nb+bp}{None}\PY{p}{,}
                        \PY{n}{homologies}\PY{o}{=}\PY{n}{cub}\PY{o}{.}\PY{n}{working\PYZus{}homoset}\PY{o}{.}\PY{n}{homo\PYZus{}namelist}\PY{p}{[}\PY{o}{\PYZhy{}}\PY{l+m+mi}{40}\PY{p}{:}\PY{p}{]}
                       \PY{p}{)}\PY{o}{.}\PY{n}{compare\PYZus{}clusters}\PY{p}{(}\PY{n}{cubdistance\PYZus{}matrix}\PY{o}{=}\PY{n+nb+bp}{True}\PY{p}{,} \PY{n}{plot}\PY{o}{=}\PY{n+nb+bp}{True}\PY{p}{,} \PY{n}{size}\PY{o}{=}\PY{l+m+mi}{40}\PY{p}{)}
\end{Verbatim}
...
loaded
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}49}]:} \PY{n}{cub}\PY{o}{.}\PY{n}{get\PYZus{}subset}\PY{p}{(}\PY{n}{homoset} \PY{o}{=} \PY{n}{cub}\PY{o}{.}\PY{n}{working\PYZus{}homoset}\PY{p}{,} \PY{n}{withcopy}\PY{o}{=}\PY{n+nb+bp}{True}\PY{p}{,} \PY{n}{clusternb}\PY{o}{=}\PY{n+nb+bp}{None}\PY{p}{,} \PY{n}{species}\PY{o}{=}\PY{n+nb+bp}{None}\PY{p}{,}
                        \PY{n}{homologies}\PY{o}{=}\PY{p}{[}\PY{n}{cub}\PY{o}{.}\PY{n}{working\PYZus{}homoset}\PY{o}{.}\PY{n}{homo\PYZus{}namelist}\PY{p}{[}\PY{n}{i}\PY{p}{]} \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n}{primaryhomo}\PY{p}{[}\PY{p}{:}\PY{l+m+mi}{6}\PY{p}{]}\PY{p}{]}\PY{p}{)}\PY{o}{.}\PY{n}{plot\PYZus{}all}\PY{p}{(}
                                                 \PY{n}{With}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{tsne}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{perplexity}\PY{o}{=}\PY{l+m+mi}{60}\PY{p}{,}
                                                  \PY{n}{interactive}\PY{o}{=}\PY{n+nb+bp}{True}\PY{p}{,} \PY{n}{iteration}\PY{o}{=}\PY{l+m+mi}{300}\PY{p}{)}
\end{Verbatim}
...
loaded
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{n}{cub}\PY{o}{.}\PY{n}{all\PYZus{}homoset}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{tsne}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{D}\PY{o}{=}\PY{l+m+mi}{2}\PY{p}{,}\PY{n}{interactive}\PY{o}{=}\PY{n+nb+bp}{True}\PY{p}{)}
\end{Verbatim}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{n}{cub}\PY{o}{.}\PY{n}{get\PYZus{}evolutionary\PYZus{}distance}\PY{p}{(}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{n}{cub}\PY{o}{.}\PY{n}{get\PYZus{}subset}\PY{p}{(}\PY{n}{homoset} \PY{o}{=} \PY{n}{cub}\PY{o}{.}\PY{n}{all\PYZus{}homoset}\PY{p}{,} \PY{n}{withcopy}\PY{o}{=}\PY{n}{T}\PY{p}{,} \PY{n}{clusternb}\PY{o}{=}\PY{n+nb+bp}{None}\PY{p}{,} \PY{n}{species}\PY{o}{=}\PY{n+nb+bp}{None}\PY{p}{,}
                       \PY{n}{homologies}\PY{o}{=}\PY{n}{cub}\PY{o}{.}\PY{n}{all\PYZus{}homoset}\PY{o}{.}\PY{n}{homo\PYZus{}namelist}\PY{p}{[}\PY{p}{:}\PY{l+m+mi}{100}\PY{p}{]}\PY{p}{)}\PY{o}{.}\PY{n}{find\PYZus{}clusters}\PY{p}{(}\PY{n}{clustering}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{dbscan}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
                            \PY{n}{trainingset}\PY{o}{=}\PY{l+m+mi}{30}\PY{p}{,} \PY{n}{epoch}\PY{o}{=}\PY{l+m+mi}{30}\PY{p}{,} \PY{n}{ranges}\PY{o}{=}\PY{p}{[}\PY{l+m+mf}{0.1}\PY{p}{,} \PY{l+m+mi}{3}\PY{p}{]}\PY{p}{,} \PY{n}{size}\PY{o}{=}\PY{l+m+mi}{10}\PY{p}{,} \PY{n}{redo} \PY{o}{=} \PY{n+nb+bp}{True}\PY{p}{,}
                            \PY{n}{homogroupnb}\PY{o}{=}\PY{l+m+mi}{2}\PY{p}{,} \PY{n}{best\PYZus{}eps} \PY{o}{=} \PY{n+nb+bp}{True}\PY{p}{,} \PY{n}{assess}\PY{o}{=} \PY{n+nb+bp}{True}\PY{p}{,} \PY{n}{eps}\PY{o}{=}\PY{l+m+mf}{0.45}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{n}{cub}\PY{o}{.}\PY{n}{get\PYZus{}subset}\PY{p}{(}\PY{n}{homoset} \PY{o}{=} \PY{n}{cub}\PY{o}{.}\PY{n}{all\PYZus{}homoset}\PY{p}{,} \PY{n}{withcopy}\PY{o}{=}\PY{n+nb+bp}{False}\PY{p}{,} \PY{n}{clusternb}\PY{o}{=}\PY{n+nb+bp}{None}\PY{p}{,} \PY{n}{species}\PY{o}{=}\PY{n+nb+bp}{None}\PY{p}{,}
                       \PY{n}{homologies}\PY{o}{=}\PY{n}{cub}\PY{o}{.}\PY{n}{all\PYZus{}homoset}\PY{o}{.}\PY{n}{homo\PYZus{}namelist}\PY{p}{[}\PY{p}{:}\PY{l+m+mi}{600}\PY{p}{]}\PY{p}{)}\PY{o}{.}\PY{n}{find\PYZus{}clusters}\PY{p}{(}\PY{n}{clustering}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{dbscan}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
                            \PY{n}{trainingset}\PY{o}{=}\PY{l+m+mi}{150}\PY{p}{,} \PY{n}{epoch}\PY{o}{=}\PY{l+m+mi}{30}\PY{p}{,} \PY{n}{ranges}\PY{o}{=}\PY{p}{[}\PY{l+m+mf}{0.1}\PY{p}{,} \PY{l+m+mi}{4}\PY{p}{]}\PY{p}{,} \PY{n}{size}\PY{o}{=}\PY{l+m+mi}{10}\PY{p}{,} \PY{n}{redo} \PY{o}{=} \PY{n+nb+bp}{True}\PY{p}{,}
                            \PY{n}{homogroupnb}\PY{o}{=}\PY{l+m+mi}{2}\PY{p}{,} \PY{n}{best\PYZus{}eps} \PY{o}{=} \PY{n+nb+bp}{True}\PY{p}{,} \PY{n}{assess}\PY{o}{=} \PY{n+nb+bp}{True}\PY{p}{,} \PY{n}{eps}\PY{o}{=}\PY{l+m+mf}{0.45}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}61}]:} \PY{n}{cub}\PY{o}{.}\PY{n}{get\PYZus{}full\PYZus{}genomes}\PY{p}{(}\PY{n}{kingdom}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{fungi}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{seq}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{cds}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{avg}\PY{o}{=}\PY{n+nb+bp}{True}\PY{p}{,} \PY{n}{by}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{entropy}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{normalized}\PY{o}{=}\PY{n+nb+bp}{False}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
parsed 1 over 66 done aspergillus\_clavatus
parsed 2 over 66 done aspergillus\_flavus
parsed 3 over 66
    \end{Verbatim}
    ...
    -> 3069         return np.exp(self.logpmf(x, n, p))
       ...
       3033         \%(\_doc\_callparams\_note)s
       3034         """
    -> 3035         n, p, npcond = self.\_process\_parameters(n, p)
       3036         x, xcond = self.\_process\_quantiles(x, n, p)
       3037 


        /home/ec2-user/miniconda2/envs/cub/lib/python2.7/site-packages/scipy/stats/\_multivariate.pyc in \_process\_parameters(self, n, p)
       2967         \# true for bad p
    ...
    ---> 38     return umr\_any(a, axis, dtype, out, keepdims)
         39 
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{n}{cub}\PY{o}{.}\PY{n}{save}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{processed\PYZus{}test}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{k}{print} \PY{n}{cub}\PY{o}{.}\PY{n}{species}\PY{p}{[}\PY{n}{cub}\PY{o}{.}\PY{n}{species}\PY{o}{.}\PY{n}{keys}\PY{p}{(}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{]}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}72}]:} \PY{n}{cub}\PY{o}{.}\PY{n}{get\PYZus{}evolutionary\PYZus{}distance}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
...
SyntaxError: invalid syntax
    ...
    The species with the highest variance seems to be all surrounding the
one with less variance in their CUB, species satoella\_complicata seems
to be far outside the regular cluster. In PCA there really seems to be
an elongated shape meaning that one dimension contains way more variance
than any other. Plant symbiotic species seem to cluster more toward low
entropy, low variance values. Only one part of the plot seems to have
brown rot bacteria but this is of low statistical significance.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}110}]:} \PY{n}{cub}\PY{o}{.}\PY{n}{compare\PYZus{}species}\PY{p}{(}\PY{n}{showvar}\PY{o}{=}\PY{n+nb+bp}{True}\PY{p}{,} \PY{n}{to}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{avg}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{reducer}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{tsne}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{perplexity}\PY{o}{=}\PY{l+m+mi}{100}\PY{p}{,} \PY{n}{eps}\PY{o}{=}\PY{l+m+mf}{0.5}\PY{p}{,} \PY{n}{size}\PY{o}{=}\PY{l+m+mi}{15}\PY{p}{)}
\end{Verbatim}
...
PyCUB/pyCUB.py:1195: RuntimeWarning: divide by zero encountered in log
  utils.rgb2hex((126, 8, 10 + np.floor(246 * dist / tRNAentropydist.max()))) for dist in np.log(np.ma.masked\_equal(tRNAentropydist, 0))]
PyCUB/pyCUB.py:1201: RuntimeWarning: divide by zero encountered in log
  tRNA\_number=tRNA\_number,
    ...
    it really seems to be difficult to regress on that low number of
datapoint, we achieve a low score, which may be the maximum given the
probably low correlation. We can see that the average size correlates
with the CUB which makes sense given the measure we use. Moreover the
GCcount seems to be really important for the regressor algorithm.
finally, we have a small inverse correlation of the CUB to the total
number of homology (maybe that the highly shared/conserved genes tend to
be ones which codon usage bias is little influenced by exterior factors.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}111}]:} \PY{n}{cub}\PY{o}{.}\PY{n}{regress\PYZus{}on\PYZus{}species}\PY{p}{(}\PY{n}{without}\PY{o}{=}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{,} \PY{n}{full}\PY{o}{=}\PY{n+nb+bp}{False}\PY{p}{,} \PY{n}{onlyhomo}\PY{o}{=}\PY{n+nb+bp}{False}\PY{p}{,} \PY{n}{perctrain}\PY{o}{=}\PY{l+m+mf}{0.8}\PY{p}{,} \PY{n}{algo}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{lasso}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}
                                     \PY{n}{eps}\PY{o}{=}\PY{l+m+mf}{0.001}\PY{p}{,} \PY{n}{n\PYZus{}alphas}\PY{o}{=}\PY{l+m+mi}{100}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
average\_size: SpearmanrResult(correlation=0.2441321746988882, pvalue=1.6034758413378369e-08)
num\_genes: SpearmanrResult(correlation=0.025754952030612056, pvalue=0.55712420802658313)
genome\_size: SpearmanrResult(correlation=0.02465102393132142, pvalue=0.57415346354289198)
tot\_homologies: SpearmanrResult(correlation=-0.15643674596871962, pvalue=0.00033360229590838011)
the R\^{}2 score is of: 0.22014424702
-------------------------------
average\_size: 0.128179698303
num\_genes: 0.122110916774
genome\_size: -0.151405740339
fullGCcount: -1.04343801117
varGCcount: -0.0
tot\_homologies: 0.00131727269688
isplant\_symbiotic: 0.0114762725523
isplant\_pathogen: -0.0
isanimal\_pathogen: 0.0
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
        ...
        <ipython-input-111-a607f6ad91e4> in <module>()
          1 cub.regress\_on\_species(without=[""], full=False, onlyhomo=False, perctrain=0.8, algo="lasso",
    ----> 2                            eps=0.001, n\_alphas=100)
    

        /home/ec2-user/PyCUB/CodonUsageBias/PyCUB/pyCUB.pyc in regress\_on\_species(self, without, full, onlyhomo, perctrain, algo, eps, n\_alphas)
       1346         if algo == "lasso":
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}86}]:} \PY{n}{cub}\PY{o}{.}\PY{n}{scorespecies}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}86}]:} 0.2555102083452766
\end{Verbatim}
            
    What a strangely well defined shape. we can see a cluster of high mean
eCAI homologies: a form of preservation which is also a place where the
mean entropy is the lowest.

Homologies with a high cost/length also seem to cluster together around
one point of high entropy (but not the highest).

a correlated thing is the number of cys regulatory elements to the
length and cost of the gene.

secreted homologies seem to sometimes be more clustered than non
secreted ones.

High mRNA abundances seems to be mostly clustered on the outside of the
plot. we can also see just how many.

Some low entropy homologies also seem to be driven by a lot of NaN
values.

similarity score seems to be influenced by the length (which is not
trivial) And there also seems to be some clusters of higher similarity
and the one of low entorpy highlited earlier.

Moreover, it is the one that has been left out as outlier by DBSCAN.

Most homologies seems to have high entropy and the others seem only to
be a few (may be a lot of outliers due to all homoset

we can see an important cluster in PCA displaying the influence of
hydrophobicity on the homologies.

\begin{itemize}
\tightlist
\item
  it is interesting that despite looking at averages over many different
  genes of different species, such relation exist despite looking mostly
  at the metadata of only SC*
\end{itemize}

\hypertarget{doing-working}{%
\paragraph{DOING working}\label{doing-working}}

The shape is now way more rounded than before. and some of the clusters
we had spotted earlier have disapeared. we have mostly the same
correlation as before

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}154}]:} \PY{n}{cub}\PY{o}{.}\PY{n}{compare\PYZus{}homologies}\PY{p}{(}\PY{n}{homoset}\PY{o}{=}\PY{n}{cub}\PY{o}{.}\PY{n}{all\PYZus{}homoset}\PY{p}{,} \PY{n}{homosapiens}\PY{o}{=}\PY{n+nb+bp}{False}\PY{p}{,}
                                 \PY{n}{mindistance}\PY{o}{=}\PY{l+m+mi}{10}\PY{p}{,} \PY{n}{preserved}\PY{o}{=}\PY{n+nb+bp}{True}\PY{p}{,}
                                     \PY{n}{size}\PY{o}{=}\PY{l+m+mi}{4}\PY{p}{,}
                                     \PY{n}{varsize}\PY{o}{=}\PY{l+m+mi}{6}\PY{p}{,} \PY{n}{minpreserv}\PY{o}{=}\PY{l+m+mf}{0.9}\PY{p}{,} \PY{n}{minsimi}\PY{o}{=}\PY{l+m+mf}{0.9}\PY{p}{,} \PY{n}{showvar}\PY{o}{=}\PY{n+nb+bp}{True}\PY{p}{,}
                                 \PY{n}{eps}\PY{o}{=}\PY{l+m+mf}{0.8}\PY{p}{,}
                                 \PY{n}{reducer}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{pca}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{perplexity}\PY{o}{=}\PY{l+m+mi}{100}\PY{p}{)}
\end{Verbatim}
    ...
    The results are pretty grim for this regression algorithm, there is
traces of hope however, some important correlation have been found and
we can see an almost linear increase of the r\^{}2 score with the
increase of datapoint.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}164}]:} \PY{n}{cub}\PY{o}{.}\PY{n}{regress\PYZus{}on\PYZus{}genes}\PY{p}{(}\PY{n}{homoset}\PY{o}{=}\PY{n}{cub}\PY{o}{.}\PY{n}{all\PYZus{}homoset}\PY{p}{,} \PY{n}{full}\PY{o}{=}\PY{n+nb+bp}{False}\PY{p}{,} \PY{n}{without}\PY{o}{=}\PY{p}{[}\PY{p}{]}\PY{p}{,}
                               \PY{n}{perctrain}\PY{o}{=}\PY{l+m+mf}{0.75}\PY{p}{,} \PY{n}{algo}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{lasso}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{eps}\PY{o}{=}\PY{l+m+mf}{0.001}\PY{p}{,} \PY{n}{n\PYZus{}alphas}\PY{o}{=}\PY{l+m+mi}{100}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
> /home/ec2-user/PyCUB/CodonUsageBias/PyCUB/pyCUB.py(1509)regress\_on\_genes()
-> for val in values[:5]:
(Pdb) c
similarity\_scores: SpearmanrResult(correlation=-0.072817143336051104, pvalue=2.7742966040990751e-08)
...
protein\_abundance: SpearmanrResult(correlation=0.056439099440282671, pvalue=1.6821875511060589e-05)
mRNA\_abundance: SpearmanrResult(correlation=-0.086933272838433981, pvalue=3.2280434415417848e-11)
decay\_rate: SpearmanrResult(correlation=0.1567485306934171, pvalue=2.9071670461463889e-33)
is\_secreted: SpearmanrResult(correlation=0.0013553018355325524, pvalue=0.91775916604867347)
cys\_elements: SpearmanrResult(correlation=0.077968371827372554, pvalue=2.6936563465393485e-09)
tot\_volume: SpearmanrResult(correlation=0.61404859129722777, pvalue=0.0)
mean\_hydrophobicity: SpearmanrResult(correlation=0.12100588754115996, pvalue=2.1802017159482846e-20)
glucose\_cost: SpearmanrResult(correlation=0.61905446084924243, pvalue=0.0)
synthesis\_steps: SpearmanrResult(correlation=0.62413262866369279, pvalue=0.0)
